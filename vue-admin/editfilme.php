      ...
      <div class="row tm-content-row">
        <div class="tm-block-col tm-col-account-settings">
          <div class="tm-bg-primary-dark tm-block tm-block-settings">
            ...
            <form action="editfilme_action.php" method="post">
            <input type="heddin" name="idfilme" value="<?php echo $filme['idfilme'] ?>" readonly class="form-control" >
                <div class="mb-3">
                    <label for="nomfilme" class="form-label">filme Name</label>
                    <input type="text" name="nomfilme" value="<?php echo $filme['nomfilme'] ?>" class="form-control" >
                </div>
                <div class="mb-3">
                    <label for="description" class="form-label">description</label>
                    <input type="text" name="description" value="<?php echo $filme['description'] ?>" class="form-control">
                </div>
                <div class="mb-3">
                    <label for="dated" class="form-label">date debut</label>
                    <input type="text" name="dated" value="<?php echo $filme['dated'] ?>" class="form-control">
                </div>
                <div class="mb-3">
                    <label for="datef" class="form-label">date fin</label>
                    <input type="text" name="datef" value="<?php echo $filme['datef'] ?>" class="form-control" >
                </div>
                <div class="mb-3">
                    <label for="image" class="form-label">Time Filme</label>
                    <input type="text" name="timefilme" value="<?php echo $filme['timefilme'] ?>" class="form-control" >
                </div>
                <div class="mb-3">
                    <label for="image" class="form-label">Image</label>
                    <input type="text" name="image" value="<?php echo $filme['image'] ?>" class="form-control" >
                </div>
                <div class="mb-3">
                    <label for="jour" class="form-label">jour</label>
                    <select name="idjour" value="<?php echo $filme['idjour'] ?>" class="form-control">
                    <?php
